    ...
    <button
      ...
      className={cn(
        ...
        active
          ...
          : 'border-slate-300 bg-white hover:border-slate-400 hover:bg-slate-50 dark:border-slate-800 dark:bg-slate-900 dark:hover:border-slate-700 dark:hover:bg-slate-800/60',
      )}
    >
      <div className="flex items-center gap-3">
        ...
        <ChevronRight className="h-4 w-4 text-slate-500 transition group-hover:text-slate-700 dark:text-slate-600 dark:group-hover:text-slate-300" />
      </div>
      ...
      <div className="mt-4 truncate rounded bg-slate-100 px-3 py-2 text-xs text-slate-600 dark:bg-slate-950 dark:text-slate-500">
