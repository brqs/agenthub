...
export const LIGHT_THEME_CONTRAST_CASES: ContrastCase[] = [
  ...
  { name: 'brand accent on light surface', foreground: '#4338ca', background: '#ffffff', minimum: 4.5 },
  { name: 'brand accent on selected light tab', foreground: '#4338ca', background: '#d3d4f6', minimum: 4.5 },
...
export const DARK_THEME_CONTRAST_CASES: ContrastCase[] = [
  { name: 'primary text on app surface', foreground: '#f1f5f9', background: '#020617', minimum: 4.5 },
  { name: 'secondary text on dark panel', foreground: '#cbd5e1', background: '#0f172a', minimum: 4.5 },
  { name: 'muted text on dark panel', foreground: '#94a3b8', background: '#0f172a', minimum: 4.5 },
  { name: 'muted text on darkest surface', foreground: '#94a3b8', background: '#020617', minimum: 4.5 },
  { name: 'brand accent on dark panel', foreground: '#a5b4fc', background: '#1e293b', minimum: 4.5 },
  ...
  { name: 'error text on error surface', foreground: '#fecdd3', background: '#4c0519', minimum: 4.5 },
  { name: 'brand button text', foreground: '#ffffff', background: '#4f46e5', minimum: 4.5 },
];
