    ...
    <div className="flex h-full flex-col bg-slate-950">
      <header className="flex min-h-[68px] items-center justify-between border-b border-slate-800 px-4 sm:min-h-[76px] sm:px-8">
        <div>
          ...
          <h1 className="mt-2 text-xl font-semibold text-white">归档会话</h1>
        </div>
      ...
      <main className="min-h-0 flex-1 overflow-y-auto p-4 scrollbar-thin sm:p-8">
        {isLoading ? (
          ...
          <div className="flex min-h-full items-center justify-center">
            <div className="max-w-sm rounded-md border border-dashed border-slate-800 bg-slate-900/50 p-8 text-center">
              <div className="mx-auto flex h-11 w-11 items-center justify-center rounded-md bg-slate-800 text-slate-400">
                <ArchiveRestore className="h-5 w-5" />
              </div>
              <h2 className="mt-4 text-sm font-semibold text-white">暂无归档会话</h2>
