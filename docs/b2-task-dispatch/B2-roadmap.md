...
| B2-03 | OpenAIAdapter 真实 OpenAI 流式接入 | P0 | 已拆解，待执行 | `backend/app/agents/adapters/openai.py` | B2-01 / B2-02 模式 |
...
1. 执行 B2-03：用 B2-02 的结构实现 OpenAIAdapter，并复用 `StreamingArtifactParser`。
2. 完成 B2-03 Codex 审阅、Git/PR 和合并。
