...
| [ai-skills/b1-contract-change/SKILL.md](ai-skills/b1-contract-change/SKILL.md) | B1 后端契约变更 Skill |
...
| [orchestrator-routing-flow.md](orchestrator-routing-flow.md) | Orchestrator 群聊消息路由流程与任务流转说明 |
...
| 目录 | 内容 |
|---|---|
| [archive/](archive/) | 过时或阶段性资料，例如原始课题 PDF、Git/PR Claude 操作资料 |
