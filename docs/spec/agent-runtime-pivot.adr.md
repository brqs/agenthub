...
- ✅ B2 已交付的 13 项 roadmap（历史归档：[docs/archive/b2-task-dispatch/B2-roadmap.md](../archive/b2-task-dispatch/B2-roadmap.md)）：
...
- 不删除历史任务分发记录；当前已归档到 [docs/archive/b2-task-dispatch/](../archive/b2-task-dispatch/)，作为 Phase 1 ModelGateway 底座的开发记录保留
- 不实现一键部署：列为 P2，演示口述
