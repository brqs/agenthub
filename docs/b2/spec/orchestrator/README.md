...
| [tool-calling.spec.md](tool-calling.spec.md) | Current contract | `dispatch_agent`、workspace tools、preview/verify、自建 Agent platform tools |
...
- Preview / browser verify / create custom agent 是 Orchestrator 可调用的平台 tool，但实际执行由平台 service 完成。
